...
public class Latihan03 extends JFrame {private  JLabel email, password, ibik;
	...
	btn_submit.addActionListener(new ActionListener () {
		...
		public void actionPerformed(ActionEvent e) {
			if(textemail.getText().isEmpty()) {
				JOptionPane.showMessageDialog(null, "Silahkan mengisi data dengan benar!", "PERINGATAN", JOptionPane.WARNING_MESSAGE);
			}
			else {
				if(e.getSource() == btn_submit) {
					JOptionPane.showMessageDialog(null, "Selamat Datang", "informasi" ,JOptionPane.INFORMATION_MESSAGE, null);
				}
			}
		}
